...
const isDesktopShell = typeof window !== 'undefined' && !!window.desktopAPI
...
function handleMinimizeToTray() {
  ...
  if (window.desktopAPI?.minimizeToTray) {
    window.desktopAPI.minimizeToTray()
  }
}
  ...
  <div class="app-shell">
    ...
    >
      <div class="window-drag-region">
        <div class="window-brand">Traffic Sign Detection</div>
      </div>
      ...
      >
        <div class="shell-action-group" :class="{ open: shellMenuOpen }">
          <div class="shell-sub-actions">
            <button
              class="shell-icon-btn danger"
              data-tip="关闭应用"
            ...
            >
              <span class="icon-square">{{ isMaximized ? '❐' : '□' }}</span>
            </button>
          </div>

          <button
            class="shell-main-action"
            data-tip="关闭应用"
            @click="handleCloseApp"
          >
            <span class="icon-line">×</span>
        ...
        <div class="boot-center">
          ...
          <template v-else>
            ...
            <div class="boot-actions">
              <button class="boot-retry-btn" @click="retryBoot">重新检测</button>
              <button
                v-if="isDesktopShell"
    ...
    <div class="page" :class="{ 'page-with-chrome': isDesktopShell }">
      <div class="hero-card">
        <div class="hero-left">
          <div class="badge">Traffic Sign Detection</div>
          <h1>交通标志识别系统</h1>
          <p class="subtitle">
